...
void Vf1_fsm___024root__trace_chg_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+3,(vlSelf->tick));
    bufp->chgSData(oldp+4,(vlSelf->N),16);
    bufp->chgCData(oldp+5,(vlSelf->data_out),8);
    bufp->chgCData(oldp+6,(vlSelf->f1_fsm__DOT__current_state),8);
    bufp->chgCData(oldp+7,(vlSelf->f1_fsm__DOT__next_state),8);
    bufp->chgSData(oldp+8,(vlSelf->f1_fsm__DOT__delay__DOT__count),16);
}
